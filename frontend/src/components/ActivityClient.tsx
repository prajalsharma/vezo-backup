...
function EventPill({ type }: { type: "sale" | "listed" | "cancelled" }) {
  const config = {
    ...
    cancelled: { icon: XCircle, label: "Cancel", color: "var(--text-3)", bg: "rgba(255,255,255,0.04)", border: "rgba(255,255,255,0.08)" },
  }[type];
  ...
  return (
    <div
      className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-[9px] font-black uppercase tracking-widest"
